...
alias tag='ctags -R; cscope -Rbkq'
alias ctty='((stty 115200 clocal cread -crtscts cs8 -cstopb hup -parenb; cat) < /dev/ttyUSB0)'

#switch java version
alias jvupdate='sudo update-alternatives --config java'

# ctrl+s cause terminator freeze
stty ixany
stty ixoff -ixon
stty stop undef
stty start undef
